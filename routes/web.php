...
// Контроллер синхронизации временно отключен для стабилизации
...
Route::middleware('auth')->group(function () {
    ...
    // Экспорт временно отключен до восстановления класса QACheckExport
    // Route::get('/export-qa-check', function() { ... })->name('export.qa-check');
});
